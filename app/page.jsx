...
const Home = () => {
  return (
    <main className="flex flex-col items-center justify-center px-6 py-16 max-w-4xl mx-auto">
      <h1
      ...
      <p className="max-w-xl text-center text-lg italic mb-10">
        ...
        Access your courses, take tests, and track your progress —
        all in a sacred golden space.
      </p>
      <Link href="/dashboard">
        <button
